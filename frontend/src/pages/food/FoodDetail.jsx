...
import { createCollection, deleteCollection, checkCollection } from '@/api/collection'
...
function FoodDetail() {
  ...
  const handleCollection = async () => {
    try {
      if (isCollected) {
        // 取消收藏（需要先获取collectionId，这里简化处理）
        message.success('取消收藏功能开发中...')
        // 实际应该先获取收藏列表，找到对应的collectionId，然后调用deleteCollection
      } else {
        // 添加收藏
